            ...
            <v-main>
                ...
                <section class="mb-8" v-if="consultant !== null">
                    <div class="bg-white p-4 shadow flex items-center">
                        <div class="mr-4">
                        <v-avatar size="72">
                            <img src="https://images.unsplash.com/photo-1615807713086-bfc4975801d0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=627&q=80" alt="Avatar">
                        </v-avatar>
                        </div>
                        <div>
                ...
                <v-container v-if="consultant !== null">
                    ...
                    <v-btn color="primary" @click="updateSkillsRating" class="validate-btn mx-auto mt-10">Valider l'évaluation</v-btn>
                </v-container>
                </div>
            </v-main>
        </v-app>
