...
const items = ref([
    { title: 'Actualités', icon: 'fa-solid fa-newspaper', to: 'news-list', value: 'news' },
    { title: 'Planning', icon: 'fa-solid fa-calendar', to: 'plannings-list', value: 'my-planning' },
    { title: 'Formations', icon: 'fa-solid fa-school', to: 'trainings-list', value: 'my-training' },
    { title: 'Succès', icon: 'fa-solid fa-trophy', to: 'achievements-list', value: 'my-achievement' },
...
const adminItems = ref([
    ...
    { title: 'Formations', icon: 'fa-solid fa-school', to: 'admin-trainings-list', value: 'admin-trainings' },
    { title: 'Skills', icon: 'fa-solid fa-hammer', to: 'admin-skills-list', value: 'admin-skills' },
]);

const clientItems = ref([
    { title: 'Mon compte', icon: 'fa-solid fa-user-gear', to: 'client-profile-show', value: 'client-account' },
