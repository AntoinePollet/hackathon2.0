        ...
        <div class="flex flex-col gap-y-1">
            ...
            >
                <div class="flex items-center px-4 py-2 gap-x-3">
                    <v-avatar
                        image="https://images.unsplash.com/photo-1615807713086-bfc4975801d0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=627&q=80"
                    ></v-avatar>
                    {{
                        currentUserLogged?.displayName ||
...
const clientItems = ref([
    {
        ...
        to: "client-profile-show",
        value: "client-account",
    },
    {
        title: "Planning",
        icon: "fa-solid fa-calendar",
        to: "client-plannings-list",
        value: "client-plannings",
    },
]);
